...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Dataset',
            fields=[
                ('id', models.SlugField(default=api.models.dataset.generate_dataset_id, primary_key=True, serialize=False, verbose_name='Id')),
        ...
        migrations.CreateModel(
            name='Model',
            fields=[
                ('id', models.SlugField(default=api.models.model.generate_model_id, primary_key=True, serialize=False, verbose_name='Id')),
                ('title', models.TextField(blank=True, verbose_name='Title')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated')),
        ...
        migrations.CreateModel(
            name='Recipe',
            fields=[
                ('id', models.SlugField(default=api.models.recipe.generate_recipe_id, primary_key=True, serialize=False, verbose_name='Id')),
                ('title', models.TextField(blank=True, verbose_name='Title')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated')),
        ...
        migrations.CreateModel(
            name='Service',
            fields=[
                ('id', models.SlugField(default=api.models.service.generate_service_id, primary_key=True, serialize=False, verbose_name='Id')),
                ('title', models.TextField(blank=True, verbose_name='Title')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated')),
        ...
        migrations.CreateModel(
            name='Token',
            fields=[
                ('id', models.SlugField(default=api.models.token.generate_token_id, max_length=32, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Workspace',
            fields=[
                ('id', models.SlugField(default=api.models.workspace.generate_workspace_id, primary_key=True, serialize=False, verbose_name='Id')),
                ('title', models.TextField(blank=True, verbose_name='Title')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated')),
