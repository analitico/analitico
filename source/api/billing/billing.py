...
def stripe_session_create(user: api.models.User, workspace: api.models.Workspace = None, plan: str = None):
    ...
    session = stripe.checkout.Session.create(
        ...
        success_url=f"https://analitico.ai/app/workspaces?checkout=success&workspace_id={workspace_id}",
        cancel_url="https://analitico.ai/app/workspaces?checkout=cancel",
        subscription_data={
