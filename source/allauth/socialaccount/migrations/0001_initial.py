...
class Migration(migrations.Migration):
    ...
    dependencies = [("sites", "0001_initial"), migrations.swappable_dependency(settings.AUTH_USER_MODEL)]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "social application", "verbose_name_plural": "social applications"},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="SocialToken",
            fields=[
                ...
                (
                    "token",
                    models.TextField(help_text='"oauth_token" (OAuth1) or access token (OAuth2)', verbose_name="token"),
                ),
                (
                    "token_secret",
                    models.TextField(
            ...
            options={"verbose_name": "social application token", "verbose_name_plural": "social application tokens"},
            bases=(models.Model,),
        ),
        migrations.AlterUniqueTogether(name="socialtoken", unique_together=set([("app", "account")])),
        migrations.AlterUniqueTogether(name="socialaccount", unique_together=set([("provider", "uid")])),
    ]
