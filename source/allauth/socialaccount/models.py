...
class SocialApp(models.Model):
    ...
    provider = models.CharField(verbose_name=_("provider"), max_length=30, choices=providers.registry.as_choices())
    name = models.CharField(verbose_name=_("name"), max_length=40)
    client_id = models.CharField(verbose_name=_("client id"), max_length=191, help_text=_("App ID, or consumer key"))
    secret = models.CharField(
        verbose_name=_("secret key"), max_length=191, help_text=_("API secret, client secret, or" " consumer secret")
    )
    key = models.CharField(verbose_name=_("key"), max_length=191, blank=True, help_text=_("Key"))
...
class SocialAccount(models.Model):
    ...
    uid = models.CharField(verbose_name=_("uid"), max_length=app_settings.UID_MAX_LENGTH)
