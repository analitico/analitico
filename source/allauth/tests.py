...
class BasicTests(TestCase):
    def test_generate_unique_username(self):
        examples = [("a.b-c@example.com", "a.b-c"), ("Üsêrnamê", "username"), ("User Name", "user_name"), ("", "user")]
    ...
    def test_serializer(self):
        ...
        instance = SomeModel(dt=datetime.now(), d=date.today(), something=some_value, t=datetime.now().time())
    ...
    def test_build_absolute_uri(self):
        self.assertEqual(utils.build_absolute_uri(None, "/foo"), "http://example.com/foo")
        self.assertEqual(utils.build_absolute_uri(None, "/foo", protocol="ftp"), "ftp://example.com/foo")
        self.assertEqual(utils.build_absolute_uri(None, "http://foo.com/bar"), "http://foo.com/bar")
