...
class Migration(migrations.Migration):
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_address",
                    models.ForeignKey(
                        verbose_name="e-mail address", to="account.EmailAddress", on_delete=models.CASCADE
                    ),
                ),
            ],
    ...
    if not UNIQUE_EMAIL:
        operations += [migrations.AlterUniqueTogether(name="emailaddress", unique_together=set([("user", "email")]))]
