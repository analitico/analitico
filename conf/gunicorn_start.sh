...
#
# nginx example:
# 127.0.0.1 - - [27/Nov/2018:17:11:21 +0100] "POST /api/v1/s24/order-sorting?format=json HTTP/1.1" 500 127 1465 0.005 0.004 "-" "PostmanRuntime/7.4.0"

# gunicorn example:
# 127.0.0.1 - - [27/Nov/2018:17:11:21 +0100] "POST /api/v1/s24/order-sorting?format=json HTTP/1.0" 500 127 1101 0.004956 0.004956 "-" "PostmanRuntime/7.4.0"
