##
# Script for running docker deamon.
# From official `docker:stable-dind` docker image
# https://github.com/docker-library/docker/blob/cad4d26d9d84c3701e8fcfc922145b569f8dfc22/18.09/dind/dockerd-entrypoint.sh
##
